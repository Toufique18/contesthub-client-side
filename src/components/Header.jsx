...
const Header = () => {
    ...
    const links = <>
        ...
        <li><NavLink className={({ isActive }) => isActive ? "btn text-purple-600 border-2 border-purple-500" : "text-neutral-900 text-opacity-80 text-lg font-normal font-['Work Sans']"} to="/contests">All contests</NavLink></li>
    ...
    return (
        <div>
            <div className="navbar bg-purple-50 border-l-purple-200 bg-base-100 container mx-auto lg:px-12 px-5 py-5">
                <div className="navbar-start">
                    ...
                    <a className=" text-xl"><img className="animate-pulse h-12" src={hub} alt="" /></a>
                </div>
